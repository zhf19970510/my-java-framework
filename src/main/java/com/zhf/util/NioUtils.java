...
import com.zhf.service.impl.StreamProgressImpl;
...
public final class NioUtils {
     ...
     * 缓冲区大小 16KB
     *
     * @see cn.hutool.core.io.NioUtil#DEFAULT_BUFFER_SIZE
     * @see cn.hutool.core.io.NioUtil#DEFAULT_LARGE_BUFFER_SIZE
     */
    // private static final int DEFAULT_BUFFER_SIZE = NioUtil.DEFAULT_MIDDLE_BUFFER_SIZE;
    ...
    public static void copyForBufferSize(Path filePath, HttpServletResponse response, ContentRange contentRange) {
        ...
        try {
            ...
            log.info("file download complete, fileName = {}, contentRange = {}", fileName, contentRange.toContentRange());
     ...
     *   at com.zhf.controller.ResourceController.download(ResourceController.java:200)
     * </pre>
     *
     * @param filePath     源文件路径
     * @param response     请求响应
